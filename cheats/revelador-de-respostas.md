...
* Cheat que revela as questões corretas e incorretas do khan academy

* Selecione e arraste para os favoritos do chrome
...
```  
* Logue no khan academy.
* E clique no atalho em favoritos.
  <br>
